...
class Podcaster2Profile(models.Model):
    user = models.OneToOneField(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
        related_name='podcaster2_profile'
    )
    ...
    def __str__(self):
        return f"{self.user.username}'s Podcaster2 Profile"
...
class Podcast2(models.Model):
    title = models.CharField(max_length=200)
    description = models.TextField()
    owner = models.ForeignKey(
        Podcaster2Profile,
        on_delete=models.CASCADE,
        related_name='podcasts2'
    )
    ...
    likes = models.ManyToManyField(
        CustomUser,
        related_name='liked_podcasts2',
        blank=True
    )
    dislikes = models.ManyToManyField(
        CustomUser,
        related_name='disliked_podcasts2',
        blank=True
    )
